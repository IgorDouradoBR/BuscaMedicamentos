...
public class Medicamento implements Comparable<Medicamento>{
    ...
    private long ean1, registro;//Classifiquei como Long por serem entradas muito grandes para serem do tipo int
    ...
    public Medicamento(String nome, String produto, String apresentacao, long registro, long ean1,
            String pisCofins, double pfSemImp, double pmc0, boolean em2020) {//Instancio o construtor
        this.nome = nome;
    ...
    @Override 
    public int compareTo(Medicamento ordenador) {//Para exercer o comparador entre os Medicamentos baseado no valor de pmc0, em ordem crescente
        if (this.pmc0 < ordenador.getPmc0()) { 
          return -1; 
          } 
          if (this.pmc0 > ordenador.getPmc0()) { 
          return 1; 
